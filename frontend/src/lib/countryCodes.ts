...
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { flag: '🇦🇬', dial: '+1-268', name: 'Antigua and Barbuda' },
  ...
  { flag: '🇰🇳', dial: '+1-869', name: 'Saint Kitts and Nevis' },
  { flag: '🇱🇨', dial: '+1-758', name: 'Saint Lucia' },
  { flag: '🇻🇨', dial: '+1-784', name: 'Saint Vincent and the Grenadines' },
  { flag: '🇼🇸', dial: '+685', name: 'Samoa' },
  { flag: '🇸🇲', dial: '+378', name: 'San Marino' },
  { flag: '🇸🇹', dial: '+239', name: 'Sao Tome and Principe' },
  ...
  { flag: '🇻🇦', dial: '+39', name: 'Vatican City' },
